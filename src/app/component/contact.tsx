...
const Contact = () => {
  return (
    <div id='Contact'>
<section className="wrapper text-gray-600 body-font relative">
    ...
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      ...
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
          ...
          <a className="text-indigo-500 leading-relaxed">shumailayousuf1000@gmail.com</a>
          <h2 className="title-font font-semibold text-gray-900 trackig-widest text-xs mt-4">
            PHONE
          </h2>
          <p className="leading-relaxed">0312-2358359</p>
        </div>
      </div>
    </div>
